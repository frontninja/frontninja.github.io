...
function tabsEvenets() {
    ...
    tabs.each(function (tab) {
        var tabsList = (0, _jquery2.default)(this).find('.tabs__list');
        var realtab = (0, _jquery2.default)(this);
        var osu = 0;
...
function tabsEvenetss() {
    ...
    tabs.each(function (t) {
        var tab = (0, _jquery2.default)(this).find('.tab');
        var osu = 0;
...
function countTimer() {
    ...
    // });
    var data_date = (0, _jquery2.default)('#countdown').data('timer');
...
(0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.s-slider__wrapper').slick({
        arrows: false,
        dots: true,
        fade: true
    });
...
elem.addEventListener("click", function () {
    var x = document.getElementById("custom-input__password");
    if (x.type === "password") {
        x.type = "text";
    } else {
        x.type = "password";
...
(0, _jquery2.default)('.user__tab').each(function (el) {

    var temp = el;
    (0, _jquery2.default)(this).click(function () {
        (0, _jquery2.default)('.user__tab').each(function () {
            (0, _jquery2.default)(this).removeClass('active');
        });
        (0, _jquery2.default)(this).addClass('active');
        (0, _jquery2.default)('.user__content').each(function (ell) {
            (0, _jquery2.default)(this).removeClass('active');
            if (temp == ell) {
                (0, _jquery2.default)(this).addClass('active');
            }
...
var mobileTrigger = (0, _jquery2.default)('.mobile-menu__trigger');

mobileTrigger.click(function (event) {
    event.preventDefault();
    (0, _jquery2.default)('.mobile-menu__dropdown').toggleClass('mobile-menu__dropdown--active');
    overlay.addClass('active');
    (0, _jquery2.default)('.mobile-menu__close').click(function () {
        (0, _jquery2.default)(".mobile-menu__dropdown").removeClass('mobile-menu__dropdown--active');
        overlay.removeClass('active');
    });
    (0, _jquery2.default)(document).mouseup(function (e) {
        var container = (0, _jquery2.default)(".mobile-menu__dropdown");
        if (container.has(e.target).length === 0) {
